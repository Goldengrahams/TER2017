        ...
        xhttp.onreadystatechange = function () {
            ...
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                if (notificationNumber == 0){
                    notificationCounter.parentNode.parentNode.classList = 'btn btn-default navbar-btn';
                }
            }
        };
    ...
    function markAllAsSeen(e) {
        ...
        xhttp.onreadystatechange = function () {
            ...
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                notificationCount.parentNode.parentNode.classList = 'btn btn-default navbar-btn';
            }
        };
        xhttp.open("POST", element.href, true);
        xhttp.send();
