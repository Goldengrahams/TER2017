 ...
 * @ORM\Entity(repositoryClass="HLIN601\MOOCBundle\Repository\VideoRepository")
 */
class Video
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="HLIN601\MOOCBundle\Entity\Streaming", cascade={"persist"})
     */
    private $streaming;
     ...
     * @return Video
     */
    public function setStreaming(\HLIN601\MOOCBundle\Entity\Streaming $streaming = null)
    {
     ...
     * Get streaming
     *
     * @return \HLIN601\MOOCBundle\Entity\Streaming
     */
